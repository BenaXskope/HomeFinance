...
class RegisterView(generics.CreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        catPred = CategoryPrognosis(categoryId=cat, value=1000)
        catPred.save()
        cat = Category(title='Технкиа', color='#05386b', account=account, prognosis=1000)
        cat.save()
        catPred = CategoryPrognosis(categoryId=cat, value=1000)
        catPred.save()
        cat = Category(title='Непрдвиденные расходы', color='#c3073f', account=account, prognosis=1000)
        cat.save()
        catPred = CategoryPrognosis(categoryId=cat, value=1000)
        catPred.save()
